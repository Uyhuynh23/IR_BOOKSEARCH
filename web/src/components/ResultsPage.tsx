...
export default function ResultsPage({
  ...
  const relatedSearches = ['Văn học Tết', 'Lí sử sách', 'Horror', 'Tiểu thuyết trinh thám'];
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <h1 style={{
            ...
            Tìm thấy {results.length} cuốn sách cho <span style={{ color: '#C41E3A' }}>'{query}'</span>
          </h1>
          <p style={{
            fontSize: '1rem',
            color: '#C41E3A',
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.9rem', color: '#6B7280' }}>Sắp xếp theo:</span>
            <select
              value={sortBy}
                ...
                >
                  ...
                  <div style={{ padding: '1rem' }}>
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: '0.85rem', color: '#6B7280', marginLeft: '0.25rem' }}>
                        ({book.average_rating})
                      </span>
                    </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    transition: 'all 0.2s',
                    boxShadow: currentPage === pageNum ? '0 2px 8px rgba(196,30,58,0.2)' : 'none',
                  }}
                  onMouseEnter={(e) => {
